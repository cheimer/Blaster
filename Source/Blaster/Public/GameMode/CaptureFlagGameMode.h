...
public:
	virtual void PlayerEliminated(ABlasterCharacter* EliCharacter,
		ABlasterPlayerController* VictimController, ABlasterPlayerController* AttackerController) override;
